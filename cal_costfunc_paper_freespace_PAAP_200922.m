...
Phase.num2 = sfunc_dataprepro_A(fullfile(oripath,'Phase\zhengli\paper2.txt'));
Phase.num4 = sfunc_dataprepro_A(fullfile(oripath,'Phase\zhengli\paper4.txt'));
Phase.num5 = sfunc_dataprepro_A(fullfile(oripath,'Phase\zhengli\paper5.txt'));
Phase.num7 = sfunc_dataprepro_A(fullfile(oripath,'Phase\zhengli\paper7.txt'));
Phase.num8 = sfunc_dataprepro_A(fullfile(oripath,'Phase\zhengli\paper8.txt'));


Amplitude.original = sfunc_dataprepro_P(fullfile(oripath,'F_original_z=0_e-field (f=10) [AmplitudePeaks].txt'));

Amplitude.num1 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper1.txt'));
Amplitude.num2 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper2.txt'));
Amplitude.num4 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper4.txt'));
Amplitude.num5 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper5.txt'));
Amplitude.num7 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper7.txt'));
Amplitude.num8 = sfunc_dataprepro_P(fullfile(oripath,'Amplitude\zhengli\paper8.txt'));
...
close all
figure;surf(PhaseMat.original);shading interp;axis([0 200 0 200 -1 1])
figure;surf(PhaseMat.num1);shading interp;axis([0 200 0 200 0 0.1])
figure;surf(PhaseMat.num2);shading interp;axis([0 200 0 200 0 0.1])
figure;surf(PhaseMat.num4);shading interp;axis([0 200 0 200 0 0.1])
figure;surf(PhaseMat.num5);shading interp;axis([0 200 0 200 0 0.1])
figure;surf(PhaseMat.num7);shading interp;axis([0 200 0 200 0 0.1])
figure;surf(PhaseMat.num8);shading interp;axis([0 200 0 200 0 0.1])


figure;surf(AmplitudeMat.original);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num1);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num2);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num4);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num5);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num7);shading interp;axis([0 200 0 200 -4 4])
figure;surf(AmplitudeMat.num8);shading interp;axis([0 200 0 200 -4 4])
