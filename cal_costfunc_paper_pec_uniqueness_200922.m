...
oripath='E:\TRpainting\CostFuncData\补充唯一性定理pec\';

Phase.original = sfunc_dataprepro_P(fullfile(oripath,'F_original_z=0_e-field (f=10) [PhasePeaks].txt'));
Phase.num1 = sfunc_dataprepro_P(fullfile(oripath,'e-field (f=10) [up_Phase_onlyEt].txt'));
Phase.num2 = sfunc_dataprepro_P(fullfile(oripath,'e-field (f=10) [down_phase_onlyEt].txt'));
Phase.num3 = sfunc_dataprepro_P(fullfile(oripath,'_e-field (f=10) [down_phase_onlyEt[1.0,180]+up_Phase_onlyEt[1.0,0.0],[10]].txt'));

Amplitude.original = sfunc_dataprepro_A(fullfile(oripath,'F_original_z=0_e-field (f=10) [AmplitudePeaks].txt'));
Amplitude.num1 = sfunc_dataprepro_A(fullfile(oripath,'e-field (f=10) [up_A_onlyEt].txt'));
Amplitude.num2 = sfunc_dataprepro_A(fullfile(oripath,'e-field (f=10) [down_A_onlyEt].txt'));
...
PhaseA.num1 = sfunc_dataprepro_A(fullfile(oripath,'e-field (f=10) [up_Phase_onlyEt].txt'));
PhaseA.num2 = sfunc_dataprepro_A(fullfile(oripath,'e-field (f=10) [down_phase_onlyEt].txt'));
PhaseA.num3 = sfunc_dataprepro_A(fullfile(oripath,'_e-field (f=10) [down_phase_onlyEt[1.0,180]+up_Phase_onlyEt[1.0,0.0],[10]].txt'));

% 重建幅度源的相位分布
AmplitudeP.original = sfunc_dataprepro_P(fullfile(oripath,'F_original_z=0_e-field (f=10) [AmplitudePeaks].txt'));
AmplitudeP.num1 = sfunc_dataprepro_P(fullfile(oripath,'e-field (f=10) [up_A_onlyEt].txt'));
AmplitudeP.num2 = sfunc_dataprepro_P(fullfile(oripath,'e-field (f=10) [down_A_onlyEt].txt'));
